...
public:
    ...
    void setupUi(QMainWindow *projet_interfaceClass)
    {
        ...
        projet_interfaceClass->resize(824, 720);
        ...
        frame->setGeometry(QRect(0, 0, 251, 650));
...
""));
        ...
        slider_nbparticule->setGeometry(QRect(10, 40, 111, 16));
        ...
        label_fps->setGeometry(QRect(10, 520, 231, 35));
        QFont font;
        ...
        label_score->setGeometry(QRect(10, 570, 231, 35));
        label_score->setFont(font);
        widget = new QWidget(centralWidget);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(250, 0, 571, 650));
